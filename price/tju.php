...
if(!empty($html)){
    ...
    $price['tala_ons']= preg_replace('/[^0-9\.]/', '', $strArray[19])/10;
    $price['tala_18']= preg_replace('/[^0-9\.]/', '', $strArray[31])/10;
    $price['tala_24']= preg_replace('/[^0-9\.]/', '', $strArray[37])/10;
    $price['old_seke']= preg_replace('/[^0-9\.]/', '', $strArray[43])/10;
    $price['new_seke']= preg_replace('/[^0-9\.]/', '', $strArray[49])/10;
    $price['nim_seke']= preg_replace('/[^0-9\.]/', '', $strArray[55])/10;
    $price['rob_seke']= preg_replace('/[^0-9\.]/', '', $strArray[61])/10;
    $price['gerami_seke']= preg_replace('/[^0-9\.]/', '', $strArray[67])/10;
