<?php
 $ch = curl_init();
    ...
    curl_setopt($ch, CURLOPT_URL, 'http://www.tala.ir/webservice/price_live.php');
    $html = curl_exec($ch);
    curl_close($ch);
if(!empty($html)){
    ...
    $price['tala_18']= preg_replace('/[^0-9\.]/', '', $strArray[2018]);
    $price['tala_24']= preg_replace('/[^0-9\.]/', '', $strArray[2094]);
    $price['old_seke']= preg_replace('/[^0-9\.]/', '', $strArray[2245]);
    $price['new_seke']= preg_replace('/[^0-9\.]/', '', $strArray[2320]);
    $price['nim_seke']= preg_replace('/[^0-9\.]/', '', $strArray[2395]);
    $price['rob_seke']= preg_replace('/[^0-9\.]/', '', $strArray[2470]);
    $price['gerami_seke']= preg_replace('/[^0-9\.]/', '', $strArray[2545]);
